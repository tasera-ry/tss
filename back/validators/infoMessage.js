...
module.exports = {
  create: [
    ...
    body('recipients').exists().withMessage('recipient is required').isString().withMessage('recipient should be string'),
    body('sender').exists().withMessage('sender is required').isString().withMessage('sender should be string'),  
  ],
  read: [
    ...
    query('recipients').customSanitizer(value => value || false).exists()
  ],
  update: [
    ...
    body('recipients').optional({checkFalsy: true}).isBoolean(),
    body('sender').optional({checkFalsy: true}).isBoolean()
  ],
  delete: [
