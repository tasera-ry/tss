...
const service = {
   ...
   */
  readWeek: async function readScheduleWeek(key, fields) {
   ...
   * @param {string[]} fields - Filter wanted properties from date range
   *
   ...
   */
  readFreeform: async function readFreeform(key, fields) {
