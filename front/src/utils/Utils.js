...
export function viewChanger() {
  ...
  try {
    ...
    table.push(
      <Link className="link" to={`/monthview/${time.format('YYYY-MM-DD')}`}>
        <div>
          {viewChanger.Month[fin]}
        </div>
      </Link>,
    ...
    table.push(
      <Link className="link" to={`/weekview/${time.format('YYYY-MM-DD')}`}>
        <div>
          {viewChanger.Week[fin]}
        </div>
      </Link>,
    ...
    table.push(
      <Link className="link" to={`/dayview/${time.format('YYYY-MM-DD')}`}>
        <div>
          {viewChanger.Day[fin]}
        </div>
      </Link>,
